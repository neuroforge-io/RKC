...
CREATE TEMP TABLE migration_0001_guard (
    version TEXT CHECK (version IS NULL OR version = '0.1.0')
) STRICT;
INSERT INTO migration_0001_guard(version)
VALUES ((SELECT value FROM schema_meta WHERE key = 'schema_version'));
DROP TABLE migration_0001_guard;

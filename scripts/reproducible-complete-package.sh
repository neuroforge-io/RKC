...
cleanup() {
  # Downloaded Go toolchains deliberately use read-only module-cache
  # directories. Restore owner traversal only for directories inside this
  # private, mktemp-created root before removing the disposable lanes.

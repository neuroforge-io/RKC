...
| real GGUF benchmark below 3.5 GiB | Active candidate evaluation | Official Gemma 4 E2B QAT Q4_0 is pinned for a fail-closed run; it remains unqualified and no default is configured until the full quality, citation, memory, and practical-throughput gate passes |
